...
% Task1 часть два. первый и второй каналы - надежные, третий не очень,
% четвертый совсем плохой. а как так получилось, что один не

% Task2 когда передатчиков больше чем приемников. - не понимаю пока. может
% что-то с мощностью

% матрица V на самом деле содержит ины об амплитуде и фазе символов и антенн (ряды
% и колонны) и то же самое с матрицей на приемнике
% в первом случае мы добавляем инфу к двум каналам от икса, во втором
% отрещаем
